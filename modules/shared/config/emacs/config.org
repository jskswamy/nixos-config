...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Krishnaswamy Subramanian"
    user-mail-address "jskswamy@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/subramk/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/subramk/bin" "/profile/bin" "/Users/subramk/.npm-packages/bin" "/Users/subramk/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
